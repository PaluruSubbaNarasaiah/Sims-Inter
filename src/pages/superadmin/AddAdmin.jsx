...
const AddAdmin = ({ admins, setAdmins, calculateRenewalDate }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const newAdmin = {
      ...
      contactNumber: formData.contactNumber, // Added contact number to new admin
      status: true, // New admins are active by default
      createdAt: today,
      planType: formData.planType,
      renewalDate: renewalDate,
      profileImage: profileImagePreview // Store the preview URL (or actual image URL after upload)
    };
    ...
    setProfileImage(null); // Reset image file
    setProfileImagePreview(null); // Reset image preview
    setFormError('');
