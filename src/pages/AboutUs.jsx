        ...
        <div className="p-6 bg-gray-50 min-h-screen font-sans">
            ...
            <div className="relative bg-gradient-to-r from-blue-700 to-blue-900 text-white p-8 rounded-lg shadow-xl mb-8 overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto text-center">
                    <h1 className="text-3xl md:text-4xl font-extrabold mb-2 leading-tight">
                        About Smart College Management System (SIMS)
                    </h1>
                    <p className="text-md md:text-lg font-light opacity-90">
                        Revolutionizing College Education Management with Innovation and Efficiency.
                    </p>
                </div>
            </div>
            ...
            {/* Main Content */}
                <p className="text-gray-700 leading-relaxed text-lg mb-6">
                    Welcome to **SIMS**, your partner in transforming college administration. Our comprehensive platform is meticulously designed to streamline daily operations, foster seamless communication among all stakeholders, and cultivate an enriching learning environment for degree students.
                </p>
                ...
                <div className="flex items-start mb-6 border-b pb-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            To empower degree colleges and universities worldwide with cutting-edge technology, fostering an environment where efficiency meets innovation, and higher education flourishes without administrative bottlenecks. We believe in building a smarter, more connected future for college education.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-start mb-6 border-b pb-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            To develop and provide an intuitive, secure, and robust management system that caters to the diverse needs of degree colleges, universities, and higher education institutions. We aim to simplify student admissions, course scheduling, attendance tracking, academic performance management, fee collection, and much more, all within a single, integrated platform.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700 leading-relaxed mb-6">
                    ...
                    <div className="flex items-center">
                        <Feather size={20} className="mr-2 text-purple-600 flex-shrink-0" />
                        <span>Comprehensive Course & Timetable Scheduling</span>
                    </div>
                    <div className="flex items-center">
                        <Feather size={20} className="mr-2 text-purple-600 flex-shrink-0" />
                        <span>Automated Attendance & Academic Performance Tracking</span>
                    </div>
                    <div className="flex items-center">
                        <Feather size={20} className="mr-2 text-purple-600 flex-shrink-0" />
                        <span>Streamlined College Fee Management</span>
                    </div>
                    <div className="flex items-center">
                        <Feather size={20} className="mr-2 text-purple-600 flex-shrink-0" />
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                    Behind SIMS is a passionate team of higher education experts, developers, and designers committed to empowering colleges and universities. We combine deep understanding of higher education needs with cutting-edge technology to build a system that truly makes a difference.
                </p>
