    ...
    const rawEvents = [
      {
        ...
        description: 'Discussion regarding student academic progress in AP Board curriculum and JEE/NEET coaching.',
        eventType: ['Meeting'],
      ...
      },
      {
        ...
        description: 'Inter-stream cultural competition featuring dance, music, drama and literary events for MPC, BiPC, CEC, MEC, and HEC students.',
        eventType: ['Cultural'],
        startDate: '2025-06-20',
        endDate: '2025-06-22',
        eventName: 'Yuva Utsav 2025',
        targetAudience: 'All Streams',
      },
      {
        id: 'evt005',
        title: 'AP Board Exam Results Declaration',
        description: 'Intermediate examination results announcement for 1st and 2nd year students across all streams.',
        eventType: ['Academic'],
        startDate: '2024-11-10',
        endDate: '2024-11-10',
        eventName: 'AP Board Results 2024',
        targetAudience: 'Students, Parents, Faculty',
      },
      {
        id: 'evt006',
        title: 'Stream Coordination Meeting',
        description: 'Monthly meeting of stream coordinators to review MPC, BiPC, CEC, MEC, and HEC curriculum progress.',
        eventType: ['Meeting'],
        status: 'cancelled',
        startDate: '2025-09-05',
        endDate: '2025-09-05',
        eventName: 'Stream Coordination Q3',
