  ...
  const faqCategories = [
      ...
      questions: [
        {
          ...
          answer: 'Go to "My Programs" section. Select a degree program to view the full list of enrolled students, along with their basic details.'
        },
        {
          id: 'stu-2',
          question: 'How can I submit grades for my program?',
          answer: 'Navigate to "Grades" > "Submit Grades". Select the specific assignment or exam, then enter grades for each student. You can save drafts and submit final grades by the semester deadline.'
        },
        {
          id: 'stu-3',
          question: 'Where can I find student attendance records?',
          answer: 'Access "Attendance" from your dashboard. Select the program and date range to view attendance history for your students. You can also export these records.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          id: 'ass-1',
          question: 'How do I create and assign new coursework?',
          answer: 'Go to "Assignments" > "Create New". Fill in assignment details, attach resources, set due dates, and select the programs or individual students. Click "Assign" to publish.'
        },
        {
          id: 'ass-2',
    ...
    },
    {
      ...
      questions: [
        {
          id: 'att-1',
          question: 'How do I mark daily attendance for my program?',
          answer: 'Navigate to "Attendance" > "Mark Daily Attendance". Select your program and the current date. Mark students as present, absent, or late. The system automatically saves your entries.'
        },
        {
          id: 'att-2',
      ...
      questions: [
        {
          ...
          answer: 'Go to "Communication" > "Messages". You can compose a new message, select recipients (individual students/parents, a whole program, or specific groups), and send. You can also view message history.'
        },
        {
          id: 'com-2',
          question: 'How can I participate in program discussions?',
          answer: 'Access the "Program Discussions" forum for each of your degree programs. You can post new topics, reply to existing threads, and moderate discussions if you have the necessary permissions.'
        }
      ]
    }
  ];
  ...
  const contactMethods = [
    {
      ...
      action: 'mailto:support@college.edu'
    },
    {
      id: 'phone',
    ...
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">lecturer Help Center</h1>
          </div>
