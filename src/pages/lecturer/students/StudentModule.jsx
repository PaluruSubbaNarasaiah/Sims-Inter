...
const MOCK_STUDENTS = [
  ...
  },
  {
    ...
    previousSchoolPhoneNumber: '040-2345-6789',
    previousSchoolStartDate: '2021-06-01',
    previousSchoolEndDate: '2023-05-31',
    documents: [{ name: 'Transfer Certificate', url: 'http://example.com/doc1.pdf' }],
  },
  {
    id: 's3',
    admissionNo: 'ADM-2024-003',
    studentId: 'BiPC2024003',
    password: 'student123',
    name: 'Sneha Devi',
    rollNumber: 'BiPC24003',
    section: 'A',
    class: 'BiPC Year 1',
    parent: 'Vinod Gupta',
    status: 'active',
  ...
  },
  {
    ...
    status: 'active',
    avatar: 'https://via.placeholder.com/150/98D8C8/000000?text=DL',
    address: '741 Kukatpally, Hyderabad, Telangana 500072',
    gender: 'Female',
    ...
    previousSchoolPhoneNumber: '040-9876-5432',
    previousSchoolStartDate: '2020-07-01',
    previousSchoolEndDate: '2022-04-30',
    documents: [{ name: 'Transfer Certificate', url: 'http://example.com/doc2.pdf' }],
  },
];
...
const StudentModule = () => {
  ...
  const classOptions = [{ value: 'all', label: 'All Streams' }, ...classes.map(cls => ({ value: cls, label: cls }))];
  ...
  const handleSaveStudent = async (studentData) => {
    ...
    try {
      ...
      setOpenViewEditModal(false); // Close the modal after save
