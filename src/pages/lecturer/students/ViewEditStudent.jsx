...
const CLASS_OPTIONS = [
  { label: 'MPC Year 1', value: 'MPC Year 1' },
  { label: 'MPC Year 2', value: 'MPC Year 2' },
  { label: 'BiPC Year 1', value: 'BiPC Year 1' },
  { label: 'BiPC Year 2', value: 'BiPC Year 2' },
  { label: 'CEC Year 1', value: 'CEC Year 1' },
  { label: 'CEC Year 2', value: 'CEC Year 2' },
  { label: 'MEC Year 1', value: 'MEC Year 1' },
  { label: 'MEC Year 2', value: 'MEC Year 2' },
  { label: 'HEC Year 1', value: 'HEC Year 1' },
  { label: 'HEC Year 2', value: 'HEC Year 2' },
];
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select options={CLASS_OPTIONS} value={getSelectValue(CLASS_OPTIONS, formData.class)} onChange={(selected) => handleSelectChange('class', selected)} placeholder="Select Stream"
