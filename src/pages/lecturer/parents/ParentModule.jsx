  ...
  const [parents, setParents] = useState([
    {
      ...
      phone: '9876543210',
      childrenIds: ['2024MPC001', '2024BIPC005'],
      address: '12-3-45, Banjara Hills, Hyderabad, Telangana',
      image: null,
    },
    {
      parentId: 'P002',
      ...
      phone: '8765432109',
      childrenIds: ['2024CEC002'],
      address: '8-2-120, Jubilee Hills, Hyderabad, Telangana',
      image: null,
    },
    {
      parentId: 'P003',
      ...
      phone: '7654321098',
      childrenIds: ['2024MEC003', '2024HEC006', '2024MPC007'],
      address: '15-8-564, Kukatpally, Hyderabad, Telangana',
      image: null,
    },
    {
      parentId: 'P004',
      ...
      phone: '6543210987',
      childrenIds: [],
      address: '4-1-78, Secunderabad, Telangana',
      image: null,
    },
    {
      parentId: 'P005',
      ...
      phone: '5432109876',
      childrenIds: ['2024BIPC004'],
      address: '22-1-345, Madhapur, Hyderabad, Telangana',
      image: null,
    },
  ]);
  ...
  const filteredParents = parents.filter(parent => {
    ...
    if (filters.searchQuery) {
      ...
      const searchFields = [
        ...
        (parent.childrenIds || []).join(', ').toLowerCase(), // Include childrenIds in search
      ];
