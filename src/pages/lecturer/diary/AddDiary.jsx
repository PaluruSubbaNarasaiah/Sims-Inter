...
export const CreateEditHomeworkModal = ({ initialData, onClose, onSave, subjectOptions }) => {
    ...
    // Options for class and section dropdowns
    const classOptions = [
        { value: 'MPC Year 1', label: 'MPC Year 1' },
        { value: 'MPC Year 2', label: 'MPC Year 2' },
        { value: 'BiPC Year 1', label: 'BiPC Year 1' },
        { value: 'BiPC Year 2', label: 'BiPC Year 2' },
        { value: 'CEC Year 1', label: 'CEC Year 1' },
        { value: 'CEC Year 2', label: 'CEC Year 2' },
        { value: 'MEC Year 1', label: 'MEC Year 1' },
        { value: 'MEC Year 2', label: 'MEC Year 2' },
        { value: 'HEC Year 1', label: 'HEC Year 1' },
        { value: 'HEC Year 2', label: 'HEC Year 2' }
    ];
    const sectionOptions = ['A', 'B', 'C', 'D'].map(sec => ({ value: sec, label: sec }));
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <Select
                                        ...
                                        value={classOptions.find(opt => opt.value === entry.classSelected)}
                                        onChange={(selected) => handleHomeworkEntryChange(entryIndex, 'classSelected', selected ? selected.value : '')}
                                    ...
                                    <div key={homeworkItemIndex} className="flex flex-col sm:flex-row gap-3 mb-4 p-3 border border-gray-200 rounded-md bg-white shadow-sm">
                                        <div className="flex-1">
                                            ...
                                            <Select
                                                ...
                                                value={formattedSubjectOptions.find(opt => opt.value === item.subject)}
