...
const AssignmentsTable = () => {
  // Sample data
  const assignments = [
    { id: 1, assignment: "Calculus: Limits and Derivatives", class: "MPC Year 1", dueDate: "2023-10-15", status: "Pending" },
    { id: 2, assignment: "Cell Biology: Research Project", class: "BiPC Year 1", dueDate: "2023-10-20", status: "Completed" },
    { id: 3, assignment: "Indian History: Essay Assignment", class: "HEC Year 2", dueDate: "2023-10-25", status: "Late" },
    { id: 4, assignment: "Physics Mechanics: Lab Report", class: "MPC Year 2", dueDate: "2023-10-18", status: "Completed" },
    { id: 5, assignment: "Organic Chemistry: Reactions", class: "BiPC Year 2", dueDate: "2023-10-22", status: "Pending" },
    { id: 6, assignment: "Economics: Market Analysis", class: "MEC Year 1", dueDate: "2023-10-30", status: "Pending" },
    { id: 7, assignment: "Commerce: Business Case Study", class: "CEC Year 1", dueDate: "2023-11-05", status: "Pending" },
    { id: 8, assignment: "Civics: Constitution Study", class: "HEC Year 1", dueDate: "2023-11-10", status: "Completed" },
  ];
