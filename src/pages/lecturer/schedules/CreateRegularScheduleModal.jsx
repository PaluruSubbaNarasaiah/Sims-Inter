...
const CreateRegularScheduleModal = ({ initialData, onClose, onSave, lecturerRegularSchedules }) => {
  ...
  useEffect(() => {
    ...
    setErrors({});
    setNewSlotErrors({});
  }, [initialData, lecturerRegularSchedules]);
  ...
  const allottedPeriods = (lecturerRegularSchedules || [])
        ...
        <div className="flex-1 overflow-y-auto pr-4">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                {initialData ? (
                  <option value={initialData.period}>{initialData.period}</option>
                ) : (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 items-end">
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full px-4 py-2 border rounded-md ${newSlotErrors.newSubject ? 'border-red-500' : 'border-gray-300'}`}
                  />
