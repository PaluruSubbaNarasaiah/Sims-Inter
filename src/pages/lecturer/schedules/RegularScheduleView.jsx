...
const RegularScheduleView = ({ lecturerRegularSchedules, onEditRegularSchedule, onDeleteRegularSchedule }) => {
  ...
  useEffect(() => {
    ...
    lecturerRegularSchedules.forEach(schedule => {
    ...
    setLoading(false);
  }, [lecturerRegularSchedules]); // Re-run effect when lecturerRegularSchedules changes
