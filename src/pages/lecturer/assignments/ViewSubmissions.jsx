...
const ViewSubmissions = ({ onBackToAssignmentModule, selectedClassFilter, allAvailableClasses }) => {
  ...
  const [mockAllSubmissions, setMockAllSubmissions] = useState([
    { submissionId: 101, assignmentTitle: "Calculus Problem Set", class: "MPC Year 1", section: "A", subject: "Mathematics", studentName: "Arjun Reddy", submittedDate: "2025-07-19", status: "Graded", grade: "A", feedback: "Excellent work on limits and derivatives.", file: { name: "arjun_calculus.pdf", content: "PDF content for Calculus by Arjun Reddy." } },
    { submissionId: 102, assignmentTitle: "Cell Biology Lab Report", class: "BiPC Year 1", section: "B", subject: "Biology", studentName: "Priya Sharma", submittedDate: "2025-07-21", status: "Pending", grade: "-", feedback: "", file: { name: "priya_biology.docx", content: "DOCX content for Biology Lab by Priya Sharma." } },
    { submissionId: 103, assignmentTitle: "Organic Chemistry Reactions", class: "BiPC Year 2", section: "A", subject: "Chemistry", studentName: "Kiran Kumar", submittedDate: "2025-07-24", status: "Graded", grade: "B+", feedback: "Good understanding of reaction mechanisms.", file: { name: "kiran_chemistry.pdf", content: "PDF content for Chemistry by Kiran Kumar." } },
    { submissionId: 104, assignmentTitle: "Microeconomics Case Study", class: "MEC Year 1", section: "C", subject: "Economics", studentName: "Sneha Rao", submittedDate: "2025-07-17", status: "Late", grade: "C", feedback: "Submitted late. Analysis needs more depth.", file: { name: "sneha_economics.docx", content: "DOCX content for Economics by Sneha Rao." } },
    { submissionId: 105, assignmentTitle: "Indian Constitution Essay", class: "HEC Year 2", section: "A", subject: "Civics", studentName: "Rahul Chandra", submittedDate: "2025-07-31", status: "Pending", grade: "-", feedback: "", file: { name: "rahul_civics.pdf", content: "PDF content for Civics by Rahul Chandra." } },
    { submissionId: 106, assignmentTitle: "Physics Mechanics Problems", class: "MPC Year 2", section: "A", subject: "Physics", studentName: "Lakshmi Devi", submittedDate: "2025-07-20", status: "Graded", grade: "B", feedback: "Good problem solving approach.", file: { name: "lakshmi_physics.pdf", content: "PDF content for Physics by Lakshmi Devi." } },
    { submissionId: 107, assignmentTitle: "Commerce Project", class: "CEC Year 1", section: "B", subject: "Commerce", studentName: "Vijay Krishna", submittedDate: "2025-07-22", status: "Pending", grade: "-", feedback: "", file: { name: "vijay_commerce.zip", content: "ZIP content for Commerce by Vijay Krishna." } },
  ]);
  ...
  const availableClasses = allAvailableClasses || ["All", "MPC Year 1", "MPC Year 2", "BiPC Year 1", "BiPC Year 2", "CEC Year 1", "CEC Year 2", "MEC Year 1", "MEC Year 2", "HEC Year 1", "HEC Year 2"];
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <p><strong>Stream:</strong> {selectedSubmission.class}</p>
