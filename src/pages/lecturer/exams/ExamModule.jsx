...
const ExamModule = () => {
  ...
  const [activeReportClass, setActiveReportClass] = useState('MPC Year 1');
  ...
  // Ensure initial activeReportClass is set if lecturerClasses exists
  useMemo(() => {
    if (activeTab === 'reports' && !activeReportClass && lecturerClasses.length > 0) {
      setActiveReportClass(lecturerClasses[0]);
    }
  }, [activeTab, activeReportClass, lecturerClasses]);
  ...
  <div className="flex flex-wrap gap-2 sm:gap-4 w-full sm:w-auto">
    ...
    <div className="flex gap-2 sm:gap-4 w-full sm:w-auto">
      ...
      >
        ...
        {activeTab === 'grades' && (
          <>
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Student Marks</h2>
