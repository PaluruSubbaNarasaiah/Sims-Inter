...
// Predefined recipient groups for a lecturer panel
const recipientOptions = [
  ...
  { value: 'mpc-year1', label: 'MPC Year 1 Students' },
  { value: 'mpc-year2', label: 'MPC Year 2 Students' },
  { value: 'bipc-year1', label: 'BiPC Year 1 Students' },
  { value: 'bipc-year2', label: 'BiPC Year 2 Students' },
  { value: 'cec-year1', label: 'CEC Year 1 Students' },
  { value: 'cec-year2', label: 'CEC Year 2 Students' },
  { value: 'mec-year1', label: 'MEC Year 1 Students' },
  { value: 'mec-year2', label: 'MEC Year 2 Students' },
  { value: 'hec-year1', label: 'HEC Year 1 Students' },
  { value: 'hec-year2', label: 'HEC Year 2 Students' },
];
...
function ComposeMessage({ onClose, onSend, onSaveDraft, replyTo }) {
  ...
  const loadIndividualRecipients = useCallback(
    debounce(async (inputValue, callback) => {
      if (!inputValue) {
        // If no input, return a small sample or common contacts (e.g., recent lecturers, students, parents)
        ...
        <div className="p-6 space-y-4 overflow-y-auto flex-1"> {/* Removed maxHeight, added flex-1 */}
          <div>
            ...
            <CreatableSelect
              ...
              placeholder="Select groups or type individual ID/name (e.g., F001, 2023CSC001, P201)..."
