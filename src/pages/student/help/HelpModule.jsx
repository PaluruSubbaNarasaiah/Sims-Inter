  ...
  const faqCategories = [
      ...
      questions: [
        {
          ...
          answer: 'You can reset your password by clicking on "Forgot Password" on the login page. A reset link will be sent to your registered college email address. If you don\'t receive the email, please check your spam folder or contact college IT support.'
        },
        {
          id: 'acc-2',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Course enrollment changes are typically handled through the Registrar\'s office. Please contact your academic advisor or the college administration for guidance on adding or dropping courses.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: 'com-2',
          question: 'Where can I find college announcements?',
          answer: 'Important college-wide and class-specific announcements are typically displayed on your dashboard or in a dedicated "Announcements" section. Make sure to check it regularly for updates.'
        }
      ]
    }
  ];
