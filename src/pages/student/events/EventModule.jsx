    ...
    const rawEvents = [
      {
        ...
        description: 'Comprehensive mock test series for JEE Main preparation covering Physics, Chemistry, and Mathematics.',
        eventType: ['Academic'],
        startDate: '2025-07-01',
        endDate: '2025-07-15',
        eventName: 'JEE Mock Test 2025',
        targetAudience: 'MPC Students, JEE Aspirants',
      },
      {
        id: 'evt002',
        title: 'NEET Biology Lab Practical',
        description: 'Special biology lab sessions for NEET preparation focusing on human physiology and plant biology.',
        eventType: ['Academic'],
        startDate: '2025-06-28',
        endDate: '2025-06-30',
        eventName: 'NEET Bio Lab Sessions',
        targetAudience: 'BiPC Students, NEET Aspirants',
      },
      {
        id: 'evt003',
        title: 'Commerce Career Guidance',
        description: 'Career counseling session for commerce students covering CA, CS, CMA, and banking opportunities.',
        eventType: ['Academic'],
        startDate: '2025-07-05',
        endDate: null,
        eventName: 'Commerce Career Fair',
        targetAudience: 'CEC/MEC Students',
      },
      {
        id: 'evt004',
        title: 'Annual Cultural Festival',
        description: 'Celebrating Telugu culture with classical dance, music performances, and literary competitions.',
        eventType: ['Cultural'],
        startDate: '2025-08-15',
        endDate: '2025-08-17',
        eventName: 'Kalanjali 2025',
        targetAudience: 'All Students',
      },
      {
        id: 'evt005',
        title: 'Intermediate Board Exam Preparation',
        description: 'Special coaching sessions and doubt clearing for AP Intermediate Board Examinations.',
        eventType: ['Academic'],
        startDate: '2025-01-15',
        endDate: '2025-02-28',
        eventName: 'Board Exam Coaching',
        targetAudience: 'All Second Year Students',
      },
      {
        id: 'evt006',
        title: 'Science Exhibition',
        description: 'Students showcase innovative science projects and experiments from Physics, Chemistry, and Biology.',
        eventType: ['Academic'],
        startDate: '2025-09-02',
        endDate: '2025-09-03',
        eventName: 'Vigyan Mela 2025',
        targetAudience: 'MPC/BiPC Students',
      },
      {
        id: 'evt007',
        title: 'Parent-Teacher Meeting',
        description: 'Discussion on student academic progress, attendance, and career guidance.',
        eventType: ['Meeting'],
        startDate: '2025-07-20',
        endDate: null,
        eventName: 'PTM July 2025',
        targetAudience: 'Parents, Teachers',
      },
      {
        id: 'evt008',
        title: 'Sports Day Championship',
        description: 'Inter-stream sports competition including cricket, volleyball, badminton, and athletics.',
        eventType: ['Sport'],
        startDate: '2025-12-10',
        endDate: '2025-12-12',
        eventName: 'Sports Fest 2025',
        targetAudience: 'All Students',
      }
    ];
