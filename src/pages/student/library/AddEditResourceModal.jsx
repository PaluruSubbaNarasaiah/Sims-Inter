...
const AddEditResourceModal = ({ initialData, onClose, onSave, classOptions }) => {
  ...
  const subjectOptions = [
    'Computer Science', 'Mathematics', 'Physics', 'Economics', 'Statistics',
    'English', 'Business Administration', 'Accounting', 'Management', 'Marketing',
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto flex-grow">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="e.g., Binary Trees, Calculus Integration"
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Useful to Courses</label>
            <Select
              isMulti
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={formData.url}
                      onChange={handleInputChange}
                      placeholder="e.g., https://github.com/algorithms/data-structures"
