...
const AssignmentSubmission = () => {
  ...
  const assignments = {
    1: { title: 'Calculus Problem Set', class: 'Mathematics', dueDate: '2025-06-25' },
    2: { title: 'Organic Chemistry Lab Report', class: 'Chemistry', dueDate: '2025-06-28' },
    3: { title: 'Cell Biology Project', class: 'Biology', dueDate: '2025-06-30' },
    5: { title: 'Business Studies Case Study', class: 'Commerce', dueDate: '2025-06-26' },
    7: { title: 'JEE Mock Test Analysis', class: 'JEE Coaching', dueDate: '2025-07-01' },
    8: { title: 'NEET Biology Practice Set', class: 'NEET Coaching', dueDate: '2025-06-29' }
  };
