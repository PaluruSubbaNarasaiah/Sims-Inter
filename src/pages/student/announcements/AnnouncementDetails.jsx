...
const targetOptions = [
  ...
  { value: 'mpc', label: 'MPC Stream' },
  { value: 'bipc', label: 'BiPC Stream' },
  { value: 'cec', label: 'CEC Stream' },
  { value: 'mec', label: 'MEC Stream' },
  { value: 'hec', label: 'HEC Stream' },
  { value: 'jee', label: 'JEE Coaching' },
  { value: 'neet', label: 'NEET Coaching' },
  { value: 'ca', label: 'CA Coaching' },
  { value: 'clat', label: 'CLAT Coaching' }
];
