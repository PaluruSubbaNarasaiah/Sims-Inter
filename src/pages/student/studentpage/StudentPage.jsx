...
const StudentPage = () => {
  ...
  // Pending Assignments data with AP intermediate subjects
  const pendingAssignments = [
    { id: 1, course: "Mathematics", title: "Differential Calculus Problems", due: "Tomorrow", priority: "high" },
    { id: 2, course: "Physics", title: "Mechanics Numerical Problems", due: "July 2", priority: "medium" },
    { id: 3, course: "JEE Coaching", title: "Previous Year Questions", due: "July 5", priority: "high" },
  ];

  // Today's Schedule data with AP intermediate subjects
  const todaySchedule = [
    { id: 1, time: "08:30 AM", course: "Mathematics", room: "Room 201", type: "lecture" },
    { id: 2, time: "10:30 AM", course: "Physics", room: "Physics Lab", type: "lab" },
    { id: 3, time: "03:00 PM", course: "JEE Coaching", room: "Coaching Hall", type: "coaching" },
  ];
  ...
  const performanceData = [
    { subject: 'Mathematics', marks: 92, full: 100 },
    { subject: 'Physics', marks: 88, full: 100 },
    { subject: 'Chemistry', marks: 85, full: 100 },
    { subject: 'English', marks: 78, full: 100 },
    { subject: 'Telugu', marks: 82, full: 100 },
    { subject: 'JEE Coaching', marks: 89, full: 100 },
  ];
  ...
  const courseProgress = [
    ...
    { name: 'JEE Coaching', progress: 89 },
  ];

  // Previous Examination Results - Sorted by date, newest first
  const previousResults = [
    { id: 1, exam: "Unit Test 1", subject: "Mathematics", date: "June 15, 2025", score: "92/100" },
    { id: 2, exam: "Unit Test 1", subject: "Physics", date: "June 16, 2025", score: "88/100" },
    { id: 3, exam: "Unit Test 1", subject: "Chemistry", date: "June 17, 2025", score: "85/100" },
    { id: 4, exam: "Quarterly Exam", subject: "English", date: "March 20, 2025", score: "78/100" },
    { id: 5, exam: "Quarterly Exam", subject: "Telugu", date: "March 22, 2025", score: "82/100" },
    { id: 6, exam: "JEE Mock Test", subject: "JEE Main Pattern", date: "May 25, 2025", score: "189/300" },
                    ...
                    <div key={cls.id} className="list-group-item border-0 px-0 py-3 d-flex align-items-start">
                      <div className={`me-3 rounded-circle d-flex align-items-center justify-content-center flex-shrink-0`}
                        style={{
                          width: '40px',
                          height: '40px',
                          backgroundColor: cls.type === 'lecture' ? '#4e73df20' : cls.type === 'lab' ? '#1cc88a20' : cls.type === 'coaching' ? '#36b9cc20' : '#f6c23e20',
                          color: cls.type === 'lecture' ? '#4e73df' : cls.type === 'lab' ? '#1cc88a' : cls.type === 'coaching' ? '#36b9cc' : '#f6c23e'
                        }}>
                        {cls.type === 'lecture' ? <FiBook size={16} /> : cls.type === 'lab' ? <FiAward size={16} /> : cls.type === 'coaching' ? <FiLayers size={16} /> : <FiClock size={16} />}
                      </div>
                      <div className="flex-grow-1">
                      ...
                      <div className="text-end d-flex flex-column align-items-end">
                        ...
                        <Badge pill bg={cls.type === 'lecture' ? 'primary' : cls.type === 'lab' ? 'success' : cls.type === 'coaching' ? 'info' : 'warning'}
                          className="px-2 py-1 mt-1" style={{ fontSize: '0.65rem' }}>
                          {cls.type}
                        </Badge>
                      </div>
