  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Navigate to Settings > College Profile. Only users with "Administrator" privileges can modify college information. Make your changes and click "Save".'
        }
      ]
    },
    {
      ...
      questions: [
        {
          id: 'stu-1',
          question: 'How do I admit a new student?',
          answer: 'Go to Admissions > New Admission. Fill in all required fields marked with an asterisk (*). You can upload supporting documents in the "Documents" section. Click "Submit Admission" when done.'
        },
        {
          id: 'stu-2',
          question: 'How can I generate student reports?',
          answer: 'Navigate to Reports > Student Reports. Select the program/semester, report type (e.g., academic, attendance), and date range. Click "Generate" to create the report which you can then download or print.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          id: 'att-1',
          question: 'How do I mark bulk attendance for a lecture?',
          answer: 'Navigate to Attendance > Daily Attendance. Select the date, program, and semester. You can mark all students present with one click, then individually modify the status for other students. The system auto-saves every 2 minutes.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Go to Communication > Announcements. Create a new announcement, select the target audience (all parents or specific programs/semesters), compose your message, and click "Send". You can schedule announcements for future delivery.'
        }
      ]
    }
  ];
  ...
  const contactMethods = [
    {
      ...
      details: 'support@collegeadmin.edu',
      action: 'mailto:support@collegeadmin.edu'
    },
    {
      id: 'phone',
