...
export const MessageProvider = ({ children }) => {
  const [messages, setMessages] = useState([
    ...
    },
    {
      ...
      content: 'Due to severe weather warnings, the college will be closed tomorrow. All lectures will resume on Monday.',
  ...
  const unreadMessageCount = messages.filter(m =>
    ...
    m.sender !== 'admin@college.edu' && // Not sent by the current user (admin)
  ...
  const handleUndoDelete = (id) => {
    setMessages(prev => prev.map(msg =>
      msg.id === id ? { ...msg, status: msg.originalStatus || 'sent', deletedAt: null, originalStatus: undefined } : msg
    ));
  };
