    ...
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
      ...
      <div className="flex justify-between mb-4">
        ...
        <div className="hidden md:flex items-center gap-2 text-xs rounded-full ring-[1.5px] ring-gray-300 px-3 w-full md:w-[400px]">
          ...
          <input
            type="text"
            placeholder="Search junior college notices..."
                    ...
                    <div className="flex flex-col items-center justify-center text-gray-500">
                      ...
                      <h3 className="text-lg font-semibold mb-1">
                        {announcements.length === 0
                          ? "No junior college notices available"
                          : "No matching junior college notices found."}
                      </h3>
                      <p className="mt-1 text-sm text-gray-600">
                        {announcements.length === 0
                          ? "There are currently no junior college notices to display"
