...
const DiaryModule = () => {
    ...
    const [allHomeworkEntriesByChild] = useState({
        'child1': [
            {
                id: 'hw1_child1',
                ...
                date: '2025-06-27',
                homeworkItems: [
                    { subject: 'Mathematics', homework: 'Complete exercises on Calculus - Differentiation (Chapter 5, pg 45-47).' },
                    { subject: 'Physics', homework: 'Solve numerical problems on Mechanics and prepare for JEE practice test.' }
                ]
            },
            {
                id: 'hw2_child1',
                ...
                date: '2025-06-26',
                homeworkItems: [
                    { subject: 'Chemistry', homework: 'Complete organic chemistry reactions worksheet and study periodic table trends.' }
                ]
            },
            {
                id: 'hw3_child1',
                ...
                date: '2025-06-25',
                homeworkItems: [
                    { subject: 'Mathematics', homework: 'Review trigonometry formulas for upcoming unit test.' }
                ]
            },
            {
                id: 'hw4_child1',
                ...
                date: '2025-06-28',
                homeworkItems: [
                    { subject: 'Physics', homework: 'Prepare lab report on Simple Pendulum experiment.' },
                    { subject: 'Mathematics', homework: 'Practice integration problems from EAPCET previous papers.' }
                ]
            },
        ],
        'child2': [
            {
                ...
                date: '2025-06-27',
                homeworkItems: [
                    { subject: 'Biology', homework: 'Draw and label human digestive system diagram and study enzyme functions.' }
                ]
            },
            {
                id: 'hw2_child2',
                ...
                date: '2025-06-25',
                homeworkItems: [
                    { subject: 'Chemistry', homework: 'Complete chemical bonding worksheet and prepare for NEET practice questions.' }
                ]
            },
            {
                id: 'hw3_child2',
                ...
                date: '2025-06-28',
                homeworkItems: [
                    { subject: 'Physics', homework: 'Study wave motion chapter and solve numerical problems.' },
                    { subject: 'Biology', homework: 'Prepare notes on photosynthesis and cellular respiration.' }
                ]
            },
        ],
        'child3': [
            {
                id: 'hw1_child3',
                lecturerId: 'lecturer_T128',
                date: '2025-06-27',
                homeworkItems: [
                    { subject: 'Commerce', homework: 'Complete accounting problems on Trial Balance and Trading Account.' }
                ]
            },
            {
                id: 'hw2_child3',
                lecturerId: 'lecturer_T129',
                date: '2025-06-26',
                homeworkItems: [
                    { subject: 'Economics', homework: 'Study demand and supply concepts and prepare case study analysis.' }
                ]
            },
            {
                id: 'hw3_child3',
                lecturerId: 'lecturer_T130',
                date: '2025-06-25',
                homeworkItems: [
                    { subject: 'Civics', homework: 'Read about Indian Constitution and fundamental rights for class discussion.' }
                ]
            },
            {
                id: 'hw4_child3',
                ...
                date: '2025-06-28',
                homeworkItems: [
                    { subject: 'Commerce', homework: 'Practice CA Foundation level problems on partnership accounts.' },
                    { subject: 'Economics', homework: 'Prepare presentation on current economic policies of India.' }
                ]
            },
        ]
    });
                            ...
                            >
                                ...
                                <div className="flex-grow">
                                    ...
                                    <small className="text-gray-500 text-xs sm:text-sm">
                                        {child.stream} - {child.year} {child.rollNo && `• Roll No: ${child.rollNo}`}
                                    </small>
                                </div>
