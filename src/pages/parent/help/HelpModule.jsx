...
const HelpModule = () => {
  ...
  const faqCategories = [
      ...
      questions: [
        {
          ...
          answer: 'You can reset your password by clicking on "Forgot Password" on the login page. A reset link will be sent to your registered email address. If you don\'t receive the email, please check your spam folder or contact college IT support.'
        },
        {
          id: 'acc-2',
    ...
    {
      id: 'communication',
      title: 'Communication with College',
      questions: [
        {
          id: 'com-1',
        ...
        {
          id: 'com-2',
          question: 'Where can I find college announcements and notices?',
          answer: 'Important college-wide announcements, circulars, and event notices are typically displayed on your main dashboard or in a dedicated "Announcements" section. Please check it regularly.'
        },
        {
          id: 'com-3',
