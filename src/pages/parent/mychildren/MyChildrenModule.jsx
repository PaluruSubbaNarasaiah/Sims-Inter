...
const MyChildrenModule = () => {
  ...
  useEffect(() => {
    ...
    const sampleData = [ // Updated sample data for Andhra Pradesh Junior Colleges
      {
        id: 'S001',
        name: 'Arjun Kumar',
        ...
        lecturer: 'Mr. Ravi Kumar',
        lecturerId: 'L001',
        address: '123, Jubilee Hills, Hyderabad, Andhra Pradesh, 500033',
      ...
      },
      {
        id: 'S003',
        name: 'Kiran Sharma',
        profileImage: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=80',
        stream: 'CEC',
        ...
        lecturer: 'Mrs. Sunitha Rao',
        lecturerId: 'L005',
        address: '456, Banjara Hills, Hyderabad, Andhra Pradesh, 500034',
        coachingPrograms: ['CA Foundation', 'CLAT'],
      },
      // {
      //   id: 'S004',
      //   name: 'Meera Patel',
      //   profileImage: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=80',
      //   stream: 'MEC',
      ...
      //   lecturer: 'Mr. Venkat Reddy',
      //   lecturerId: 'L006',
      //   address: '789, Kondapur, Hyderabad, Andhra Pradesh, 500084',
      //   coachingPrograms: ['CA Foundation', 'BBA Entrance'],
      // },
      // {
      //   id: 'S005',
      //   name: 'Rahul Naidu',
      ...
      //   lecturer: 'Dr. Sita Devi',
      //   lecturerId: 'L007',
      //   address: '321, Gachibowli, Hyderabad, Andhra Pradesh, 500032',
      //   coachingPrograms: ['CLAT', 'Civil Services'],
      // },
    ];
              ...
              <div className="p-6">
                ...
                <div className="space-y-4 text-gray-700 mb-8">
                  <div className="flex items-center gap-3 bg-blue-50/50 p-3 rounded-lg border border-blue-100">
                    ...
                    <span className="font-semibold text-gray-800">Stream:</span> {child.stream} - {child.year} ({child.section || 'N/A'})
                  </div>
          ...
          <div className="relative bg-white rounded-xl shadow-2xl p-8 w-full max-w-2xl transform transition-all duration-300 scale-100 opacity-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-gray-700"> {/* Added gap-x and gap-y */}
              <div className="flex items-center gap-2"> {/* Reduced gap */}
                ...
                <span className="font-semibold text-sm">Stream:</span> <span className="text-sm">{selectedChild.stream} - {selectedChild.year} ({selectedChild.section || 'N/A'})</span> {/* Adjusted text size */}
              </div>
              <div className="flex items-start gap-2 col-span-1 md:col-span-2">
                <BookOpen size={18} className="text-indigo-600 mt-1" />
                <span className="font-semibold text-sm">Subjects:</span> 
                <span className="text-sm">{selectedChild.subjects ? selectedChild.subjects.join(', ') : 'N/A'}</span>
              </div>
              ...
              <div className="flex items-start gap-2 col-span-1 md:col-span-2">
                <Award size={18} className="text-yellow-600 mt-1" />
                <span className="font-semibold text-sm">Coaching:</span>
                <span className="text-sm">
                  {selectedChild.coachingPrograms && selectedChild.coachingPrograms.length > 0
                    ? selectedChild.coachingPrograms.join(', ')
                    : 'Not Enrolled'}
                </span>
              </div>
            </div>
