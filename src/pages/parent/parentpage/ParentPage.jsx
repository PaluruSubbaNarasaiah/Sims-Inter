    ...
    children: [
      {
        ...
        coachingPrograms: ['JEE (Mains + Advanced)', 'EAPCET'],
        attendance: [
        ...
        performance: [
          ...
          { subject: 'Physics', score: 92, average: 78 },
          { subject: 'Chemistry', score: 75, average: 70 }
        ],
        events: [
          { id: 1, title: "Parent-Lecturer Meeting", date: "July 15, 2024", time: "4:00 PM" },
          { id: 3, title: "Quarterly Exams", date: "July 25, 2024", time: "9:00 AM" }
        ],
        payments: [
          { id: 1, date: "July 1, 2024", amount: "₹25000.00", status: "Paid", isPaid: true },
          { id: 2, date: "June 1, 2024", amount: "₹5000.00", status: "Paid", isPaid: true },
          { id: 4, date: "Aug 1, 2024", amount: "₹25000.00", status: "Pending", isPaid: false }
        ],
        examResults: [
          { id: 1, subject: "Mathematics", type: "Quarterly Exam", score: 79, maxScore: 100, date: "May 1, 2024", icon: <FaClipboardCheck /> },
          { id: 2, subject: "Physics", type: "Unit Test", score: 70, maxScore: 100, date: "April 28, 2024", icon: <FaClipboardCheck /> },
          { id: 3, subject: "Chemistry", type: "Quarterly Exam", score: 88, maxScore: 100, date: "April 15, 2024", icon: <FaClipboardCheck /> },
          { id: 4, subject: "English", type: "Half-Yearly Exam", score: 75, maxScore: 100, date: "March 20, 2024", icon: <FaClipboardCheck /> },
          { id: 5, subject: "Physics Practical", type: "Practical Exam", score: 91, maxScore: 100, date: "Jan 10, 2024", icon: <FaAward className="text-info" /> },
        ]
      },
      {
        id: 'S002',
        ...
        performance: [
          { subject: 'Biology', score: 85, average: 80 },
          { subject: 'Physics', score: 78, average: 72 },
          { subject: 'Chemistry', score: 90, average: 85 }
        ],
        events: [
          { id: 2, title: "Science Fair", date: "July 20, 2024", time: "10:00 AM" },
          { id: 3, title: "Annual Day", date: "July 25, 2024", time: "9:00 AM" }
        ],
        payments: [
          { id: 3, date: "May 1, 2024", amount: "₹30000.00", status: "Paid", isPaid: true },
          { id: 5, date: "Sept 1, 2024", amount: "₹30000.00", status: "Pending", isPaid: false }
        ],
        examResults: [
          { id: 1, subject: "Biology", type: "Quarterly Exam", score: 72, maxScore: 100, date: "April 10, 2024", icon: <FaClipboardCheck /> },
          { id: 2, subject: "Physics", type: "Unit Test", score: 80, maxScore: 100, date: "April 5, 2024", icon: <FaClipboardCheck /> },
          { id: 3, subject: "Chemistry", type: "Quarterly Exam", score: 95, maxScore: 100, date: "March 28, 2024", icon: <FaAward className="text-info" /> }
        ]
      },
      {
        id: 'S003',
        ...
        coachingPrograms: ['CA Foundation', 'CLAT'],
        attendance: [
          { name: 'Present', value: 42, color: '#1cc88a' },
          { name: 'Absent', value: 5, color: '#e74a3b' },
          { name: 'Late', value: 3, color: '#f6c23e' }
        ],
        performance: [
          { subject: 'Commerce', score: 82, average: 78 },
          { subject: 'Economics', score: 89, average: 75 },
          { subject: 'Civics', score: 76, average: 72 }
        ],
        events: [
          { id: 4, title: "Commerce Fair", date: "July 18, 2024", time: "2:00 PM" },
          { id: 5, title: "Economics Debate", date: "July 22, 2024", time: "11:00 AM" }
        ],
        payments: [
          { id: 6, date: "June 1, 2024", amount: "₹22000.00", status: "Paid", isPaid: true },
          { id: 7, date: "Aug 1, 2024", amount: "₹22000.00", status: "Pending", isPaid: false }
        ],
        examResults: [
          { id: 1, subject: "Commerce", type: "Quarterly Exam", score: 85, maxScore: 100, date: "April 12, 2024", icon: <FaClipboardCheck /> },
          { id: 2, subject: "Economics", type: "Unit Test", score: 78, maxScore: 100, date: "April 8, 2024", icon: <FaClipboardCheck /> },
          { id: 3, subject: "Civics", type: "Quarterly Exam", score: 82, maxScore: 100, date: "March 30, 2024", icon: <FaClipboardCheck /> }
        ]
      }
    ]
  };
                ...
                >
                  <Card.Body className="d-flex align-items-center p-3">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <small className="text-muted d-block">{child.stream} - {child.year} {child.rollNumber && `• Roll No: ${child.rollNumber}`}</small>
                      {child.subjects && <small className="text-muted">{child.subjects.join(', ')}</small>}
                    </div>
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="mb-0 text-dark-emphasis">
                  {selectedChild.stream} - {selectedChild.year}
                  {selectedChild.rollNumber && ` • Roll No: ${selectedChild.rollNumber}`}
                  {selectedChild.subjects && ` • ${selectedChild.subjects.join(', ')}`}
                </p>
              </div>
            </div>
            <Button
              ...
              onClick={handleViewProfile} // Updated onClick handler
            >
            ...
            <Card.Body className="d-flex flex-column p-4">
              ...
              <div className="d-grid gap-3">
                ...
                <Button
                  ...
                  onClick={handlePayFees} // Updated to navigate to /fees
                >
                  <FaRupeeSign className="me-3" size={20} /> Pay Junior College Fees
                </Button>
                <Button
                ...
                >
                  <FaBook className="me-3" size={20} /> View Academic Reports
                </Button>
              </div>
            </Card.Body>
          </Card>
